<?php
/* $Id: editprofile.php,v 1.12.2.14 2004/10/20 10:20:39 ajv Exp $ */
/*
    XMB 1.9
...
// Pre-load templates
loadtemplates('footer_load','footer_querynum','footer_phpsql','footer_totaltime','error_nologinsession','memcp_profile_avatarurl','memcp_profile_avatarlist','admintool_editprofile','header','footer','css','error');
...
else
{
    ...
    $bday           = isset($bday) ? checkInput($bday, 'no', 'no', 'javascript', false) : '';
